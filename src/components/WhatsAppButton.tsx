...
export default function WhatsAppButton() {
    ...
    const message = "Hello MorleyAI, I would like to discuss my organization's service requirements and explore a potential collaboration with your engineering team.";
